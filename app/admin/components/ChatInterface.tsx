  ...
  return (
    <div className="flex flex-col items-center px-6 py-8 text-center" style={{ animation: 'fadeUp .5s ease' }}>
      ...
      <p className="text-sm text-slate-500 font-medium mb-1">
        Tu asistente clínico de Vanty ABA
      </p>
      ...
      {/* Preguntas rápidas */}
      <p className="text-xs font-bold text-slate-400 mb-3">{t('aria.dondeEmpezamos')}</p>
        ...
        <div className="shrink-0 px-5 py-4 flex items-center gap-3 border-b border-slate-100"
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="text-xs text-slate-400 font-medium truncate">
              Asistente clínico IA · {childName ? `Historial de ${childName}` : 'Vanty ABA'}
            </p>
          </div>
          {/* Botón silenciar voz */}
