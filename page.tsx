...
const CONTENT = {
  es: {
    ...
    footer: {
      ...
      copy: '© 2025 Jugando Aprendo — Centro de Desarrollo Infantil · Pisco, Ica, Perú. Todos los derechos reservados.',
    },
  ...
  en: {
    ...
    footer: {
      ...
      copy: '© 2025 Jugando Aprendo — Child Development Center · Pisco, Ica, Peru. All rights reserved.',
    },
      ...
      <section id="ubicacion" className="lp-map-section">
        ...
        <div className="lp-map-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 9, marginBottom: 20 }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, fontSize: 13, color: '#44403c' }}>
              <Phone size={15} color="#25d366" /><span>+51 924 807 183</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', gap: 9, fontSize: 13, color: '#44403c' }}>
              <Mail size={15} color="#f59e0b" /><span>tallerjugandoaprendoind@gmail.com</span>
            </div>
          </div>
