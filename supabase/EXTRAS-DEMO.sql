-- ════════════════════════════════════════════════════════════════════
-- EXTRAS DEMO — correr DESPUÉS de esquema-original.sql, UNA vez.
-- Junta: centros-demo + google-calendar-id + multi-tenant + center-settings.
-- Todo idempotente (se puede re-correr). Pegar completo en el SQL Editor del demo.
-- ════════════════════════════════════════════════════════════════════
